<template>
    <v-container grid-List-md>
      <v-btn
       color="primary"
      text
    v-on:click="consultarInactivos()">inactivos</v-btn>
      <v-snackbar
  ...
  methods: {
    ...
    initialize() {
      let direcciondoc = "http://localhost:3000/api/TipoCurso/";
        ...
        let direccion = "http://localhost:3000/api/Curso/recreativos";
        axios.get(direccion)
                    .then( res =>{
    ...
    consultarInactivos(){
          let varestado
              if(this.valorBoton){
                ...
                let direccion = "http://localhost:3000/api/Curso"+varestado;
