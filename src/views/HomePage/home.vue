  ...
  <v-app light>
    <!-- <v-toolbar class="white">
      <v-toolbar-title class="mx-0" >
        ...
        <v-img
          :src="require('@/assets/images/logos/Sacris_logo.png')"
    ...
    >
      <template v-slot:img="{ props }">
        <v-img
          v-bind="props"
          gradient="to top right, rgba(191, 129, 199,0.7), rgba(244, 245, 250,0.9)"
        ></v-img>
      </template>


        <div class="vertical-nav-header d-flex items-center ps-0 mt-12 ">

        <v-img
          :src="require('@/assets/LogosSacris.png')"
