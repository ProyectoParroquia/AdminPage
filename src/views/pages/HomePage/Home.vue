<template>
  <v-app  inspire class="overflow-hidden" style="margin:0; " >
    ...
    >
      <template v-slot:img="{ props }">
        <v-img
          v-bind="props"
          gradient="to top right, rgba(191, 129, 199,0.7), rgba(175, 57, 153,0.8)"
        ></v-img>
      </template>
      ...
      <!-- <v-app-bar-title style=""> -->
        <div class="vertical-nav-header d-flex items-center ps-3 pe-5 ">

        <v-img
          :src="require('@/assets/images/logos/LogosSacris.png')"
          min-height="50px"
          min-width="50px"
          max-height="50px"
          max-width="50px"
    ...
    fixed
      ...
      max-height="600"
    >
      <v-container style="margin:100px">

    <v-content style="margin-top:auto;">
      <section>
